...
public class CommonCustomerService implements CustomerService {
  ...
  public Customer save(Customer customer) {
    ...
    if (customer == null) {
      throw new IllegalArgumentException("Customer field cannot be empty!");
    }

    if (customer.getName() == null || customer.getName().isEmpty()) {
      throw new IllegalArgumentException("Name of the customer should be filled in!");
    }
  ...
  public List<Customer> getAllActiveCustomers() {
    ...
    if (customers.isEmpty()) {
      throw new NoSuchElementException("Database doesn't contain any customers");
    }
    return customers;
  }
